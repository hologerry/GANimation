...
def test_and_save(model, data, save_path):
    ...
    save_image(fake_img, save_path, nrow=fake_img.size(0), normalize=True, padding=0)
...
def main():
    ...
    result_dir = ospj(opts.output_dir, "results_ganimation")
